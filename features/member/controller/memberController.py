...
from features.transaction.model.transactionTicket import TransactionTicket
from shared.db import mysqlConnector
from shared.enum.role import Role

member_bp = Blueprint('member', __name__, url_prefix='/member', template_folder="../view", static_folder="../view", static_url_path="/member")
