...
from features.member.controller.memberController import getMemberData
from shared.db import mysqlConnector
from shared.enum.role import Role

account_bp = Blueprint('account', __name__, url_prefix='/account', template_folder="../view", static_folder="../view", static_url_path="/account")
